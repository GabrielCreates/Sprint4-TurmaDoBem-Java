...
public class DoacaoService {
    ...
    public DoacaoService(DoadorBO doadorBO) {
        this.doadorBO = doadorBO;
    }

    public void exibir(Scanner sc) throws SQLException, ClassNotFoundException, ErroNegocioException {
        System.out.println("\n1 - Registrar doacao");
        ...
        if (sub == 1) {
            ...
            for (Doacao d : bo.listarTodas()) System.out.println(d);
        } else if (sub == 3) {
